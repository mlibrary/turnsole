...
RSpec.describe Turnsole::Heliotrope::Service do
  ...
  #
  # UPDATE 2026-01-12 I don't know when these tests were last run, probably a long time ago,
  # but that monograph on preview is long gone.

  # service = described_class.new
  describe 'noids' do
    # 2026-01-12 I don't know when these tests were last run, probably a long time ago,
    # but that monograph on preview is long gone.
    skip("These tests rely on a specific monograph on Heliotrope preview that is no longer available")
